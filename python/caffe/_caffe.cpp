...
#define BP_REGISTER_SHARED_PTR_TO_PYTHON(PTR) do { \
   ...
   boost::python::converter::registration* reg = \
...
void Net_Save( Net<Dtype>& net, string filename) {
  NetParameter net_param;
  net.ToProto(&net_param, false);
  WriteProtoToBinaryFile(net_param, filename.c_str());
}

void Net_SaveHDF5( Net<Dtype>& net, string filename) {
  net.ToHDF5(filename);
}
...
Solver<Dtype>* GetSolverFromFile( string& filename) {
...
class NCCL {
 public:
  NCCL(shared_ptr<Solver<Dtype> > solver,  string& uid) {}
};
#endif
...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  bp::class_<Net<Dtype>, shared_ptr<Net<Dtype> >, boost::noncopyable >("Net",
    ...
    .def("copy_from", static_cast<void (Net<Dtype>::*)( string&)>(
  ...
  bp::class_<Blob<Dtype>, shared_ptr<Blob<Dtype> >, boost::noncopyable>(
    ...
    .add_property("shape",
        bp::make_function(
            static_cast< vector<int>& (Blob<Dtype>::*)() const>(
                &Blob<Dtype>::shape),
            bp::return_value_policy<bp::copy_const_reference>()))
  ...
  bp::class_<Layer<Dtype>, shared_ptr<PythonLayer<Dtype> >,
    boost::noncopyable>("Layer", bp::init< LayerParameter&>())
  ...
  bp::class_<Solver<Dtype>, shared_ptr<Solver<Dtype> >, boost::noncopyable>(
    ...
    .def("solve", static_cast<void (Solver<Dtype>::*)( char*)>(
  ...
  bp::class_<NCCL<Dtype>, shared_ptr<NCCL<Dtype> >,
    boost::noncopyable>("NCCL",
                        bp::init<shared_ptr<Solver<Dtype> >,  string&>())
#ifdef USE_NCCL
