...
DEFINE_string(phast_conf_file, "phast_conf_file",
    "PHAST configuration file to retrieve parallelization parameters.");
DEFINE_string(phase, "",
...
int main(int argc, char** argv) {
  ...
  try
  {
    phast::configuration_file::get_instance(FLAGS_phast_conf_file);
  }
  catch(const std::runtime_error&)
  {
    std::cerr << "Please, provide a valid PHAST configuration file" << std::endl;
    return 1;
  }
